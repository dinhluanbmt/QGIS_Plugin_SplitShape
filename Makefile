...
SOURCES = \
	__init__.py \
	modim_splitshape.py modim_splitshape_dialog.py

PLUGINNAME = modim_splitshape

PY_FILES = \
	__init__.py \
	modim_splitshape.py modim_splitshape_dialog.py

UI_FILES = modim_splitshape_dialog_base.ui
...
QGISDIR=C:\Users\모디엠\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
